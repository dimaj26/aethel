...
* **Protocol**:
  ...
  8. **Walkthrough Report (MANDATORY)**: After the checklist is complete, author `walkthrough.md` — the session/task report — using the structure below, then validate it:
